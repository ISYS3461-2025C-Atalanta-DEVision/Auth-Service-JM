...
// This file temporarily stores OAuth2 authorization state in cookies 
// (instead of server sessions) during the Google login flow to maintain 
// stateless authentication while securely verifying the OAuth2 callback.
