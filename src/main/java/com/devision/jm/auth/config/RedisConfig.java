 ...
 * - Token revocation tracking (2.3.2)
 * - Brute-force protection tracking (2.2.2)
 * - Session caching
 *
 * Supports SSL/TLS for cloud Redis providers (Upstash, Redis Cloud, etc.)
 */
@Configuration
public class RedisConfig {
    ...
    public RedisConnectionFactory redisConnectionFactory() {
        ...
        // Enable SSL/TLS for cloud Redis (Upstash requires SSL)
        if (sslEnabled) {
